...
Crime.create = (newCrime, result) => {
  ...
  //Reading a crime
  //================================================================================================
  Crime.findById = async (crimeId, result) => {
    ...
    console.log('Resultado final:', lCrime, lVictims, lWeapons, lCriminals);
    result (null, {'crime'  : await lCrime,
                   'victims': await lVictims,
                   'weapons': await lWeapons,
                   'criminals': await lCriminals});
  };
